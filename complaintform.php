...
<h2>Fill The Complaint</h2>
<button onclick="hidenshow()">AUDIO</button>
<form action="#" method="post" enctype = "multipart/form-data" >
  <label for="name">Name:</label><br>
  <input type="text" id="name" name="name" value="" /><br><br>
  <label for="Phone">Phone:</label><br>
  <input type="num" id="phone" name="phone" value="" /><br><br>
  <label for="E-mail">E-mail:</label><br>
  <input type="mail" id="E-mail" name="Email" value="" /><br><br>
  <label for="complaint">Complaint:</label><br>
  <textarea id="complaint" name="complaint" rows="10" cols="50"></textarea><br><br>
  <div id="warning">
  ...
  <label for="myfile">Upload Proof:</label>
  <input type="file" id="myfile" name="image"><br><br>
  <input type="submit" name="submit" value="Submit"><br><br>
  <label for="pharsediv">results:</label>
  <textarea name="voiceoutput" id="phraseDiv" style="display: inline-block;width:500px;height:200px"></textarea>
  <br>
...
<div id="content" style="display:none">
        <table id="tablesr">
            <tr>
                <td><input hidden id="key" value="32aee7b25c2a42778419a040ee6e5a58" type="text" size="60" placeholder="required: speech subscription key"></td>
            </tr>
            <tr>
                <td align="left">
                    <select hidden id="regionOptions">
            ...
            <tr>
                ...
                <td align="left">
                    ...
                    <input hidden type="radio"
                        ...
                        value="File"/>
                    <label hidden id="inputSourceFileLabel" for="inputSourceFileRadio">Audio file</label>
                    <button hidden id="inputSourceChooseFileButton" disabled="true">...</button>
                    <input hidden type="file" id="filePicker" accept=".wav" style="display:none" />
                </td>
            </tr>
            <tr>
                <td align="left">
                    <select hidden id="scenarioSelection">
                        ...
                        <option selected value="translationRecognizerContinuous">Continuous translation</option>
            ...
            <tr id="translationOptionsRow">
                ...
                <td>
                    <label hidden for="languageTargetOptions">Target language</label>
                    <!-- For a full list of supported languages see:
                        https://docs.microsoft.com/azure/cognitive-services/speech-service/language-support#text-to-speech-->
                    <select hidden id="languageTargetOptions">
            ...
            <tr>
                <td hidden align="right">Events:</td>
...
<script>
function hidenshow(){
    var x = document.getElementById("tablesr");
        ...
        function setScenario() {
            var startButtonText = (function() {
                switch (scenarioSelection.value) {
                    ...
                    case 'translationRecognizerContinuous': return 'Start';
                }
            })();
...
if (isset($_POST['submit'])){
  ...
  $errors= array();
      ...
      $file_ext_s=($_FILES['image']['name']);
      $file_arr = explode('.',$file_ext_s);

         $file_end_ext = strtolower(end($file_arr));

      $extensions= array("jpeg","jpg","png");
      
      if(in_array($file_end_ext,$extensions)=== false){
  ...
  $dir = "images/".$file_name;
      ...
      $voiceOutput=$_POST['voiceoutput'];
      $Date=date("d-M-Y");  

    $sql2="insert into `complaintform`(Name,Phone,Email,Complaint,File,complaint_id,status,Date,voiceoutput) value('$Name','$Phone','$Email','$Complaint','$file_name','','pending','$Date','$voiceOutput')"; 
if(mysqli_query($conn,$sql2)){

   $random=rand(1111,9999);
   $complaint_id=mysqli_insert_id($conn);
   $insert_complaint_id=$random.$complaint_id;
   $update_complaint="update complaintform set  complaint_id='$insert_complaint_id' where id='$complaint_id'";
   if(mysqli_query($conn,$update_complaint)){ 

echo "your complaint id is'$insert_complaint_id'";
